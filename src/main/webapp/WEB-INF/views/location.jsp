...
<div class="site_body">
  ...
  <div class="site_content">
    ...
    <p>We suggest you use public transportation! (In fact, that's how we plan to get there!)</p>
    <p>The COASTER train goes from downtown San Diego to the Oceanside Transit Center in about an hour.
       It costs $6.50 to go one way or $15 for a day pass. </p>
    <p> <a href='https://www.gonctd.com/services/coaster-commuter-rail/' target="_blank"> Click here for more info about the COASTER train</a></p>
      <p> From the Oceanside Transit Center, you can call a ride-share or walk the last 1.6 miles to the beach house. </p>
  </div>
  <div class="site_content">
